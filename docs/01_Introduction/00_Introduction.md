...
Download the [**User Manual**](http://udoo.org/download/files/UDOO_X86/Doc/UDOO_X86_MANUAL_Rel.1.1.pdf) to have more complete explanation of the UDOO X86 hardware.
